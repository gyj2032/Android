...
import com.allen.bean.GroupBean;
import com.allen.uitl.BaseIntentUtil;
import com.allen.uitl.PhoneUtil;
import com.allen.uitl.Util;
import com.allen.view.adapter.HomeContactAdapter;
import com.allen.view.adapter.MenuListAdapter;
import com.allen.view.other.SizeCallBackForMenu;
import com.allen.view.sms.MessageBoxList;
import com.allen.view.ui.MenuHorizontalScrollView;
import com.allen.view.ui.QuickAlphabeticBar;
	...
	private void setAdapter(List<ContactBean> list) {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				PhoneUtil.call(getApplicationContext(), cb.getPhoneNum());
			}
		});
		personList.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
				ContactBean cb = (ContactBean) adapter.getItem(position);
				PhoneUtil.showOptionDialog(HomeContactActivity.this, cb.getDisplayName(), cb.getPhoneNum());
				return true;
			}
		});
	}
...
//		Util.showListDialog(this, cb.getDisplayName(), lianxiren1,
...
//							PhoneUtil.call(getApplicationContext(), toPhone);
//							break;
//						case 1:// 发短息
//							String threadId = PhoneUtil.getSMSThreadId(getApplicationContext(), cb.getPhoneNum());
